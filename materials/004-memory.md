...
- В LOH нет поколений.  
- LOH не сжимается автоматически для повышения производительности. Т. е. отсутствует стратегия Sweep при сборке мусора: двигать большие объекты дорого. Можно выполнить сжатие вручную.
